...
import EditablePage, { Card } from "../../components/editable-page";

export default function Characters() {
  return (
    <Wrapper paperComponent title="PERSONAGENS">
    <Typography variant="h4" fontFamily="Griffy">Comuns</Typography>
    <EditablePage wrapper={false} pageTitle="Comuns" attribute="personagem">
    <Typography variant="h4" fontFamily="Griffy">NPCs</Typography>
      <EditablePage wrapper={false} pageTitle="NPCs" attribute="npc" />
    </EditablePage>
